...
var _run_throw_catch = Module['_run_throw_catch'] = createExportWrapper('run_throw_catch', 0);
var _run_rethrow = Module['_run_rethrow'] = createExportWrapper('run_rethrow', 0);
var _run_uncaught = Module['_run_uncaught'] = createExportWrapper('run_uncaught', 0);
...
(() => {
  // Create a small, never-async wrapper around EhModule which
  // checks for callers incorrectly using it with `new`.
  var real_EhModule = EhModule;
  EhModule = function(arg) {
    if (new.target) throw new Error("EhModule() should not be called with `new EhModule()`");
    return real_EhModule(arg);
  }
})();
if (typeof exports === 'object' && typeof module === 'object') {
  module.exports = EhModule;
  // This default export looks redundant, but it allows TS to import this
  // commonjs style module.
  module.exports.default = EhModule;
