...
test("DAP resolves source and variables from separate DWARF", async () => {
  session = await DAPFixtureSession.attach("separate_dwarf", {
  ...
  assert.equal(variables.body.variables.find((variable) => variable.name === "n").value, "10");
});
