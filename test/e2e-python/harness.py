...
FIXTURES = [
    {
        "name": "factorial",
        "module": "test/fixtures/simple/math.wasm",
        "expect_func": "compute_factorial",
        "expect_file": "math.cpp",
        "page_dir": "test/fixtures/simple",
        "fire": "runFactorial()",
    ...
    {
        "name": "oop",
        "module": "test/fixtures/oop/oop.wasm",
        "expect_func": "area",
        "expect_file": "oop.cpp",
        "page_dir": "test/fixtures/oop",
        "fire": "run()",
        "break_func": "area",
    },
    {
        "name": "parser",
        "module": "test/fixtures/parser/parser.wasm",
        "expect_func": "parse_factor",
        "expect_file": "parser.cpp",
        "page_dir": "test/fixtures/parser",
        "fire": "run()",
        "break_func": "parse_factor",
    },
    {
        "name": "ledger",
        "module": "test/fixtures/ledger/ledger.wasm",
        "expect_func": "apply_transaction",
        "expect_file": "ledger.cpp",
        "page_dir": "test/fixtures/ledger",
        "fire": "run()",
        "break_func": "apply_transaction",
    },
    {
        "name": "types",
        "module": "test/fixtures/types/types.wasm",
        "expect_func": "stop_here",
        "expect_file": "types.cpp",
        "page_dir": "test/fixtures/types",
        "fire": "run()",
        "break_func": "stop_here",
    },
    {
        "name": "heap",
        "module": "test/fixtures/heap/heap.wasm",
        "expect_func": "check_heap",
        "expect_file": "heap.cpp",
        "page_dir": "test/fixtures/heap",
        "fire": "run()",
        "break_func": "check_heap",
    },
    {
        "name": "trap",
        "module": "test/fixtures/trap/trap.wasm",
        "expect_func": "divide",
        "expect_file": "trap.cpp",
        "page_dir": "test/fixtures/trap",
        "fire": "runDivZero()",
        "break_func": "divide",
    },
]
